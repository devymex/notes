...
论文中为了突显其方法优势，使用算法复杂度来表示 $\left|\Omega\right|$ 的规模：因为 $r$ 和 $m$ 都远小于 $n$，且 $30$ 为常量系数，因此 $O\left(\left|\Omega\right|\right)=rn\log{m}$ ，即对于每个用户而言，只需收集 $r\log{m}$ 个对象的评分

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkxNzMwMDE1NiwxNjI2ODc5ODkxLC0yMT
