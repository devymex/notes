...
因为奇异值和特征值的相关性，且矩阵的特征值之和等于迹，所以核范数又被称为「迹范数」。故优化问题可表述如下：



令$l\left(z\right)=\max{\left(0,1-z\right)}$ 为hinge 损失函数，希望可以
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MjY2MjcyMjcsMzIwODcyODI4LC0xMD
g1MDc0MjU4LC00NDM2MTY5ODUsMTYyNjg3OTg5MSwtMjEzMzcx
NTAzMiw2MDYxMDk0Niw3MjEyMzAxMzldfQ==
-->